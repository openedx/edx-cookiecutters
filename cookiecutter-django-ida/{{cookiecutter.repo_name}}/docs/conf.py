...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', '{{ cookiecutter.project_name }}.settings.test')
django_setup()
...
#
# html_title = '{{ cookiecutter.project_name }} v{{ cookiecutter.version }}'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, '{{ cookiecutter.project_short_description }}',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, '{{ cookiecutter.project_name }}'),
                os.path.join(root_path, '{{ cookiecutter.project_name }}/migrations')])
