...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'repo_name.settings.test')
django_setup()
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'repo_name'),
                os.path.join(root_path, 'repo_name/migrations')])
