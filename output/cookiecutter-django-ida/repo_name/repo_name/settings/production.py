...
from repo_name.settings.base import *
from repo_name.settings.utils import get_env_setting
...
# This may be overridden by the YAML in repo_name_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

if 'REPO_NAME_CFG' in environ:
    CONFIG_FILE = get_env_setting('REPO_NAME_CFG')
