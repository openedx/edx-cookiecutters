...
from repo_name.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get('REPO_NAME_SECRET_KEY', 'insecure-secret-key')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'repo_name.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'repo_name_sessionid'
CSRF_COOKIE_NAME = 'repo_name_csrftoken'
LANGUAGE_COOKIE_NAME = 'repo_name_language'
