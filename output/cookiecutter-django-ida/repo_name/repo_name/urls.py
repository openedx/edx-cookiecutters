...
from repo_name.apps.api import urls as api_urls
from repo_name.apps.core import views as core_views
...
urlpatterns = oauth2_urlpatterns + [
    ...
    re_path(r'^api-docs/', get_swagger_view(title='repo_name API')),
